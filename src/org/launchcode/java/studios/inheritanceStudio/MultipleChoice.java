...
public class MultipleChoice extends Question {
    ...
    public MultipleChoice(String aQuestion, int aPointValue, ArrayList<String> possibleAnswers, int correctAnswer) {
    ...
    public boolean isCorrectAnswer(int possibleAnswers) {
